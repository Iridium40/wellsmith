...
export default function GetStarted() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-16">
      <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">Get Started with OPTAVIA</h1>
      <p className="mt-3 text-lg text-muted-foreground">Official program overview and next steps</p>

      <div className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border bg-card p-6 shadow-sm">
          <h2 className="text-xl font-bold">Program Overview</h2>
          <p className="mt-2 text-sm text-foreground/80">Different plan options are available. You'll pair scientifically designed products with self‑prepared Lean & Green meals, guided by your coach and community.</p>
        </div>
        <div className="rounded-2xl border bg-card p-6 shadow-sm">
