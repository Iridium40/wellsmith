  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16">
      <SEO
        ...
        description="Tips for success on the Trilivy Optimal Weight 5 & 1 Plan®, hydration guidance, and coaching resources in one place."
      />
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <p className="text-lg text-muted-foreground">
          Practical tips for success on the Trilivy Optimal Weight 5 & 1 Plan®,
        ...
        <div className="mt-4 flex items-center justify-center gap-3">
          ...
          <ShareButton
            ...
            size="sm"
            title="Client Support | WellSmith"
            description="Tips for success on the Trilivy Optimal Weight 5 & 1 Plan®, hydration guidance, and resources."
          />
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border bg-card p-6 shadow-sm">
          <h2 className="text-xl font-bold">Success Tips for the Trilivy Optimal Weight 5 & 1 Plan®</h2>
          <ul className="mt-3 grid gap-2 text-sm text-foreground/80">
            <li>
              Eat all 5 fuelings plus 1 Trilivy Lean & Green™—set reminders if needed.
            </li>
            <li>
              Keep Trilivy Lean & Green™ simple: 5–7 oz lean protein + 3 servings
              non‑starchy veggies.
            </li>
            <li>
