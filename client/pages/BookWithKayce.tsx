    ...
    <div>
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">Book with Kayce</h1>
          <p className="mt-3 text-lg text-muted-foreground">Schedule a time that works best for you. Your current timezone: {tz}</p>

          <div className="mt-8 w-full overflow-hidden rounded-xl border bg-card p-2 shadow-sm">
            {!calendlyUrl ? (
              <div className="p-6 text-sm text-muted-foreground">
                Booking is temporarily unavailable. Please try again later or use the contact page.
              </div>
            ) : (
              <iframe
