...
export default function FAQs() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16">
      <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">FAQs</h1>
      <p className="mt-3 text-lg text-muted-foreground">Answers to the most common questions about working together.</p>
