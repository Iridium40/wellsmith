  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose prose-slate mt-6 max-w-none leading-relaxed prose-p:my-4 prose-p:indent-6 space-y-6">
        ...
        <p>
          Mix sources to cover amino acids and preferences: poultry, fish, lean beef, eggs, Greek yogurt, cottage cheese,
          tofu, tempeh, soy milk, and legumes. Plant‑forward eaters can pair foods (e.g., beans + tofu) to hit targets.
        </p>
        <p>
          Convenience matters. Keep ready‑to‑eat options on hand: rotisserie chicken, tuna packets, pre‑cooked shrimp,
          egg bites, Greek yogurt cups, or shelf‑stable protein shakes that align with your plan.
        </p>
        <p>
          Cook once, eat twice. Batch‑cook proteins (grilled chicken, turkey meatballs, baked salmon) and combine with
          quick vegetables for fast weeknight meals. Season generously—herbs and spices make lean choices exciting.
        </p>
        <p>
