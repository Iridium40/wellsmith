  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="prose prose-slate mt-6 max-w-none">
        <ul>
          <li>
            Many do well at 0.7–1.0 g protein per lb of goal body weight
            (individualize).
          </li>
          <li>
            Distribute across meals (20–35 g each) to maximize muscle protein
            synthesis.
          </li>
          <li>
            Mix sources: poultry, fish, lean beef, eggs, dairy, soy, and
            legumes.
          </li>
        </ul>
      </div>
