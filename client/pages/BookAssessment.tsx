  ...
  return (
    <div>
      <SEO
        ...
        description="Book a free 30‑minute health assessment with Kayce to discuss goals and the Trilivy program."
      />
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Complete the health assessment below and Kayce will email you to
            ...
            <div>
              <div className="mb-4 flex justify-center">
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2Fa42b6f9ec53e4654a92af75aad56d14f%2Fb696cd51d34f42b981c5ca22f91044b6"
                  alt="Kayce Smith"
        ...
        <div className="rounded-2xl border bg-card p-8 shadow-sm">
          ...
          {result === "success" && (
            <div className="mt-6 rounded-md border border-emerald-200 bg-emerald-50 p-4 text-emerald-900">
              Thanks! Your Health Assessment was submitted successfully. Kayce
