...
export const MY_STORY_PARAGRAPHS: string[] = [
  ...
  "Trilivy helped me change my relationship with food and gave me the structure and energy to be the wife and mom I wanted to be. That experience led me to coaching—so others can feel what I felt.",
